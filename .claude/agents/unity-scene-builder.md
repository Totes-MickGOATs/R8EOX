...
git add path/to/ExactFile.unity.meta   # ← REQUIRED for new files (Unity auto-generates these)
...
- A file without its `.meta` = broken references (magenta materials, missing scripts)
