...
namespace R8EOX.Input.Internal
{
    ...
    internal static class InputMath
    {
        ...
        internal static float ApplyDeadzone(float raw, float deadzone)
        {
        ...
        internal static float ApplySteeringCurve(float rawSteer, float exponent)
        {
        ...
        internal static float ApplySymmetricDeadzone(float raw, float deadzone)
        {
        ...
        /// </summary>
        internal static float MergeInputs(float a, float b)
        {
