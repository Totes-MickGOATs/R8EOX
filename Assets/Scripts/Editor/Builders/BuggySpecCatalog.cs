...
namespace R8EOX.Editor.Builders
{
    internal static class BuggySpecCatalog
    {
        internal static BuggySpec Get2WD() => new BuggySpec(
            ...
            mass: 1.5f, centerOfMass: new Vector3(0f, -0.20f, 0f),
            frontSpringStrength: 75f, frontSpringDamping: 4.25f,
            rearSpringStrength: 75f, rearSpringDamping: 4.25f,
        ...
        internal static BuggySpec Get4WD() => new BuggySpec(
            ...
            restDistance: 0.20f, overExtend: 0.08f, minSpringLen: 0.032f, maxSpringForce: 50f,
            mass: 1.7f, centerOfMass: new Vector3(0f, -0.10f, 0f),
            frontSpringStrength: 65f, frontSpringDamping: 3.8f,
            rearSpringStrength: 40f, rearSpringDamping: 3.2f,
