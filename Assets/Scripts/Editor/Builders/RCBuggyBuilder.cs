...
namespace R8EOX.Editor.Builders
{
    ...
    internal static class RCBuggyBuilder
    {
        ...
        {
            AddBoxMesh(root, "ChassisPlate",     new Vector3(1.3f, 0.08f, 3.4f),
                new Vector3(0f, -0.5825f,  0f),   darkGrey);
            AddBoxMesh(root, "FrontBumperMesh",  new Vector3(1.2f, 0.3f,  0.25f),
                new Vector3(0f, -0.3825f,  1.95f), darkGrey);
            AddBoxMesh(root, "RearBumperMesh",   new Vector3(1.0f, 0.4f,  0.4f),
                new Vector3(0f, -0.3825f, -1.8f),  darkGrey);
            AddBoxMesh(root, "FrontShockTower",  new Vector3(1.0f, 0.6f,  0.05f),
                new Vector3(0f, -0.1825f,  1.2f),  medGrey);
            AddBoxMesh(root, "RearShockTower",   new Vector3(0.8f, 0.6f,  0.05f),
                new Vector3(0f, -0.1825f, -1.2f),  medGrey);
            AddBoxMesh(root, "BodyShell",        new Vector3(1.2f, 0.4f,  2.8f),
                new Vector3(0f, -0.125f,   0.2f),  blueSemi);

            GameObject wing = AddBoxMesh(root, "RearWing",
                new Vector3(1.2f, 0.02f, 0.4f), new Vector3(0f, 0.4175f, -1.5f), blueSolid);
            wing.transform.localRotation = Quaternion.Euler(-22.5f, 0f, 0f);
        }

        static void AddControlArms(GameObject root, Material darkGrey)
        {
            AddBoxMesh(root, "FrontArmL", new Vector3(0.65f, 0.05f, 0.2f),
                new Vector3(-0.65f, -0.5325f,  1.7f), darkGrey);
            AddBoxMesh(root, "FrontArmR", new Vector3(0.65f, 0.05f, 0.2f),
                new Vector3( 0.65f, -0.5325f,  1.7f), darkGrey);
            AddBoxMesh(root, "RearArmL",  new Vector3(0.65f, 0.05f, 0.2f),
                new Vector3(-0.65f, -0.5325f, -1.7f), darkGrey);
            AddBoxMesh(root, "RearArmR",  new Vector3(0.65f, 0.05f, 0.2f),
                new Vector3( 0.65f, -0.5325f, -1.7f), darkGrey);
        }
